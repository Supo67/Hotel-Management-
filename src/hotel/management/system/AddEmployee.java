...
public class AddEmployee extends JFrame implements ActionListener
{
    ...
    AddEmployee()
    {
        ...
        add(job);
        String str[]={"Manager","Front Office","Housekeeping","Food and Beverage Service","Kitchen or Food Production","Engineering and Maintenance","Accounts and Credits","Security","Human Resources(HR)","Sales and Marketing","Purchase","Information Technology(IT)"};
        ...
        l1.setBounds(380,40,500,500);
        add(l1);
        
        JLabel l2=new JLabel("ADD EMPLOYEE DETAILS");
        l2.setForeground(Color.BLUE);
        l2.setBounds(450,10,400,30);
